field_Rep_1 <- read_table("C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/field_Rep_1.txt")

# Need over time values, not just peak values.
Effects_Rep_1to3_LAIPeak_06_2022 <- (as.matrix(read_table("C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/Effects_Rep_1to3_LAIPeak_06_2022_2.txt", col_names = FALSE)))

testcollin <- sapply(1:nrow(Effects_Rep_1to3_LAIPeak_06_2022), function(i) collin(Effects_Rep_1to3_LAIPeak_06_2022[1,], N=52)) # need all days here, per trajectory?

# plot(testcollin)
testcollin$collinearity
boxplot(1-1/testcollin$collinearity)

collin(matrix(LAIAbsEffects[,12], ncol=52)[1:2,], N=52)
...
# Initialize
library(gtools)
field_Rep_1 <- 'C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/field_Rep_1.txt'
field_Rep_2 <- 'C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/field_Rep_3.txt'
field_Rep_3 <- 'C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/field_Rep_2.txt'
parameterbounds <- 'C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Model code/EE Analysis/Input/ParametersMaize.txt'
simulationpoints <- 'C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Model code/EE Analysis/Input/SimulationPoints_Rep_1.txt'
...
write.table(fieldRFRSensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/fieldRFRSensMatrix.txt")
write.table(assCOtwoSensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/assCOtwoSensMatrix.txt")
write.table(fAbsSensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/fAbsSensMatrix.txt")
write.table(BiomSensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/BiomSensMatrix.txt")
write.table(YieldSensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/YieldSensMatrix.txt")
write.table(LAISensMatrix, file = "C:/Users/Rik/OneDrive - RMIT University/zzz_Personal/PhD papers/Paper ApplyEE/Supplementary material/Outputs and processed data/EE Analysis/LAISensMatrix.txt")
...
# colourarray <- colorRampPalette(brewer.pal(8, "Accent"))(length(uniqueindices))
# #
# # par(xpd=FALSE) #square
# # if(1 %in% indicesfieldRFR){
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(fieldRFRSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
# # } else {
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(fieldRFRSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col="gray")
# # }
...
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(assCOtwoSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
# # } else {
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(assCOtwoSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col="gray")
# # }
# # for(j in 2:(nrOfParameters)){
...
# # par(xpd=FALSE) #square
# # if(1 %in% indicesfAbs){
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(fAbsSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
# # } else {
# #   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(fAbsSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col="gray")
# # }
# # for(j in 2:(nrOfParameters)){
# #   if(j %in% indicesfAbs){
...
# par(xpd=FALSE) #square
# if(1 %in% indicesBiom){
#   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(BiomSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
# } else {
#   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(BiomSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col="gray")
# }
# for(j in 2:(nrOfParameters)){
#   if(j %in% indicesBiom){
...
# legend("topleft", legend=c(27,30,48,3), fill = colourarray[which(uniqueindices %in% indicesBiom)], col = colourarray[which(uniqueindices %in% indicesBiom)], title="Param.")
# #
# par(xpd=FALSE) #square
...
# }
# title("Yield")
# legend("topleft", legend=c(51,48,3), fill = colourarray[which(uniqueindices %in% indicesYield)], col = colourarray[which(uniqueindices %in% indicesYield)], title="Param.")
# #
# par(xpd=FALSE) #square
# if(1 %in% indicesLAI){
#   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(LAISensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
# } else {
#   plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(LAISensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab="S_chi", type="l", col="gray")
# }
# for(j in 2:(nrOfParameters)){
#   if(j %in% indicesLAI){
...
# legend("topleft", legend=c(19,6,48,52,3), fill = colourarray[which(uniqueindices %in% indicesLAI)], col = colourarray[which(uniqueindices %in% indicesLAI)], title="Param.")
# #